...
* */
    ...
    public static final String PRIV_MSG = "/priv_msg";
    ...
    public static String getPrivateMsg(String user, String message) {
        return  PRIV_MSG+ DELIMITER + System.currentTimeMillis() +
                DELIMITER + user + DELIMITER + message;
    }
}
